...
run fis_ranges.m
in1 = dist_ft; % Input 1 range ft/min
in2 = vel_ftm; % Input 2 range knots
out1 = unit_mag; % Output range %
fisc2 = addInput(fisc2,in1,'Name',"d_v");
fisc2 = addInput(fisc2,in2,'Name',"V_z");
...
% Input 1 MFs
fisc2 = addMF(fisc2,"d_v",@trapmf,[in1(1) in1(1) a ab],"Name","Negative","VariableType","input");
fisc2 = addMF(fisc2,"d_v",@trimf,[a ab b],"Name","Zero","VariableType","input");
fisc2 = addMF(fisc2,"d_v",@trapmf,[ab b in1(2) in1(2)],"Name","Positive","VariableType","input");

% Input 2 MFs
fisc2 = addMF(fisc2,"V_z",@trapmf,[in2(1) in2(1) c cd],"Name","Negative","VariableType","input");
fisc2 = addMF(fisc2,"V_z",@trimf,[c cd d],"Name","Zero","VariableType","input");
fisc2 = addMF(fisc2,"V_z",@trapmf,[cd d in2(2) in2(2)],"Name","Positive","VariableType","input");
