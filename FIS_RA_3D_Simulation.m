...
if true
    ...
    filename = 'scenarios\scenario_coll_'+string(n_colliding_uavs_post)+'.mat';
...
figure()
plot(Thist,penalty_coll_over_time(t_comp))
hold on
plot(Thist,penalty_sep_over_time(t_comp))
plot(Thist,cost_over_time(t_comp))
xlabel("time (sec)")
ylabel("Cost")
