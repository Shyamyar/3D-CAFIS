...
% Input 1 MFs
fisa2 = addMF(fisa2,in1_name,@trapmf,[in1(1) in1(1) a ab],"Name","Negative","VariableType","input");
fisa2 = addMF(fisa2,in1_name,@trimf,[a ab b],"Name","Zero","VariableType","input");
fisa2 = addMF(fisa2,in1_name,@trapmf,[ab b in1(2) in1(2)],"Name","Positive","VariableType","input");

% Input 2 MFs
fisa2 = addMF(fisa2,in2_name,@trapmf,[in2(1) in2(1) c cd],"Name","Negative","VariableType","input");
fisa2 = addMF(fisa2,in2_name,@trimf,[c cd d],"Name","Zero","VariableType","input");
fisa2 = addMF(fisa2,in2_name,@trapmf,[cd d in2(2) in2(2)],"Name","Positive","VariableType","input");
