...
% Input 2 MFs
fisa3 = addMF(fisa3,in2_name,@trapmf,[in2(1) in2(1) c cd],"Name","Low","VariableType","input");
fisa3 = addMF(fisa3,in2_name,@trimf,[c cd d],"Name","Medium","VariableType","input");
fisa3 = addMF(fisa3,in2_name,@trapmf,[cd d in2(2) in2(2)],"Name","High","VariableType","input");
