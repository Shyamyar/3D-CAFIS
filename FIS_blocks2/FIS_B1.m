...
% Input 1 MFs
fisb1 = addMF(fisb1,in1_name,@trapmf,[in1(1) in1(1) a ab],"Name","Negative","VariableType","input");
fisb1 = addMF(fisb1,in1_name,@trimf,[a ab b],"Name","Zero","VariableType","input");
fisb1 = addMF(fisb1,in1_name,@trapmf,[ab b in1(2) in1(2)],"Name","Positive","VariableType","input");
