...
Field_DR_in_out = [chrom_del_chi_d, chrom_del_psi_oi, chrom_V_x, chrom_d_h, chrom_del_chi_ca,...
             chrom_del_V_ca_h, chrom_del_h_d, chrom_d_v, chrom_V_z, chrom_W_h, chrom_del_h_ca, ...
             chrom_del_V_ca_z, chrom_W_v];
