...
fisb1 = addInput(fisb1,in3,'Name',in3_name);
...
% Input 3 MFs
fisb1 = addMF(fisb1,in3_name,@trapmf,[in3(1) in3(1) c cd],"Name","Negative","VariableType","input");
fisb1 = addMF(fisb1,in3_name,@trimf,[c cd d],"Name","Zero","VariableType","input");
fisb1 = addMF(fisb1,in3_name,@trapmf,[cd d in3(2) in3(2)],"Name","Positive","VariableType","input");
