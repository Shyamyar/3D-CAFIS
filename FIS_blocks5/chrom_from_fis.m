...
% [d_h, del_psi_oi, del_chi_d, V_x, del_chi_ca, del_V_ca_h, 
% d_v_mag, d_v, del_h_d, V_z, del_h_ca, del_V_ca_z, W_h, W_v] 
% for Chromosome of GA

Field_DR_in_out = [chrom_d_h, chrom_del_psi_oi, chrom_del_chi_d, chrom_V_x, ...
    chrom_del_chi_ca, chrom_del_V_ca_h, chrom_d_v_mag, chrom_d_v, ...
    chrom_del_h_d, chrom_V_z, chrom_del_h_ca, chrom_del_V_ca_z, ...
    chrom_W_h, chrom_W_v];
