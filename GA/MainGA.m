...
OBJ_F = @(vec) CostFun(vec,fis1);   % Name of function for objective values

FieldDR = [-pi*ones(1,9) -10*ones(1,9) -10*ones(1,9) ones(1,9);pi*ones(1,9) 10*ones(1,9) 10*ones(1,9) 3*ones(1,9)]; % Range of the population defined based on the ranges for each of the inputs and output variables
...
% Best FIS
best_fis = CreateBestFIS(Elite(1,:),fis1);
writeFIS(best_fis,'TrainedInvPendCart2.fis');
